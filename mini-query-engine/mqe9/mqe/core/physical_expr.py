...
def _wrap_arrow_result(out: Any, result_type: pa.DataType | None) -> ArrowColumn:
...
def _binary_compute(
    ...
    python_fallback: Callable[[Any, Any], Any] | None,
...
def lit(value: Any, data_type: pa.DataType | None = None) -> LiteralExpression:
